...
export function ProjectEditModal({
  ...
  return (
    <div className="fixed inset-0 bg-overlay/70 backdrop-blur-sm z-50 flex items-center justify-center">
      
      {/* CONTAINER DA MODAL (Tamanho Aumentado) 
        ...
        <div className="p-6">
          <Form {...form}>
            ...
            <form onSubmit={form.handleSubmit(handleSubmit)} className="space-y-6"> 
              ...
              {/* PRIMEIRA LINHA */}
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6"> {/* Aumentei gap-4 para gap-6 */}
                <FormField
