...
import { TIPOS_ATIVIDADE, DadosAtividade, TipoAtividade } from '@/backend/core/models/Atividade';
...
import { hhmmToSeconds, adjustHHMM, formatHHMM } from '@/app/utils/time';
...
const ModalAdicionarAtividade: React.FC<ModalAdicionarAtividadeProps> = ({
  ...
  loading = false
    ...
    const [formData, setFormData] = useState<Omit<DadosAtividade, 'tempo' | 'tmp_executado'> & { tempo: string, tmp_executado: string }> ({
      titulo: '',
